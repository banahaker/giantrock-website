    ...
    <div>
      ...
      <Section bgColor="bg-gray-50">
        <div className="text-center max-w-4xl mx-auto">
          <SectionHeader
            title="專注台灣傳統製造業的資安夥伴"
            subtitle="巨磐資安培訓學院深耕台灣中小企業市場，理解傳統製造業在數位轉型過程中面臨的資安挑戰。我們提供實戰導向、接地氣的資安培訓，幫助企業建立堅實的資安防護能力。"
          />
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
            <div className="bg-white p-5 border-2 border-gray-200">
              ...
              <div className="text-gray-700 text-sm font-medium">企業客戶</div>
            </div>
            <div className="bg-white p-5 border-2 border-gray-200">
              <div className="text-3xl font-bold text-secondary-600 mb-1">
                30%
            ...
            <div className="bg-white p-5 border-2 border-gray-200">
              ...
              <div className="text-gray-700 text-sm font-medium">培訓人次</div>
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section bgColor="bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-5 border-l-4 border-secondary-500 hover:border-accent-500 transition-colors duration-200">
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              協助企業申請政府培訓補助，最高可補助 80%，大幅降低培訓成本負擔。
            </p>
          </div>
          <div className="bg-white p-5 border-l-4 border-secondary-500 hover:border-accent-500 transition-colors duration-200">
