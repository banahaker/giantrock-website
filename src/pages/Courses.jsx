        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white rounded-lg shadow-xl overflow-hidden border-t-4 border-primary-600">
            <div className="p-8">
              ...
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">課程簡介</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                  根據統計，超過 90% 的資安事件起因於「人」的疏失，而非技術漏洞。
              ...
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">培訓方案</h3>
                  ...
                  <div className="bg-gradient-to-br from-primary-50 to-primary-100 p-6 rounded-lg">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start">
                        ...
                        <span><strong>時長：</strong>4 小時</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 mr-2">•</span>
                      ...
                      <li className="flex items-start">
                        <span className="text-primary-600 mr-2">•</span>
                        <span><strong>形式：</strong>實體內訓</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 mr-2">•</span>
                        <span><strong>人數：</strong>15-30 人</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 mr-2">•</span>
                        <span><strong>內容：</strong>講師授課 + 真實案例討論 + 模擬演練</span>
                      </li>
                    </ul>
                  </div>
                  <div className="bg-gradient-to-br from-secondary-50 to-secondary-100 p-6 rounded-lg">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start">
                        ...
                        <span><strong>時長：</strong>2 小時影片 + 測驗</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-secondary-600 mr-2">•</span>
                      ...
                      <li className="flex items-start">
                        <span className="text-secondary-600 mr-2">•</span>
                        <span><strong>形式：</strong>線上平台不限次數觀看</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-secondary-600 mr-2">•</span>
                        <span><strong>適合：</strong>彈性時間、分散地點的員工</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-secondary-600 mr-2">•</span>
                        <span><strong>內容：</strong>影片教學 + 線上測驗 + 完訓證書</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">學習成果</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="flex items-start">
                    <span className="text-green-500 text-xl mr-2">✓</span>
                    <span className="text-gray-700">90% 員工能正確識別釣魚郵件</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 text-xl mr-2">✓</span>
                    <span className="text-gray-700">了解社交工程常見手法</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 text-xl mr-2">✓</span>
                    <span className="text-gray-700">建立良好的密碼管理習慣</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 text-xl mr-2">✓</span>
                    <span className="text-gray-700">企業資安意識文化提升</span>
                  </div>
                </div>
              </div>

              <div className="mb-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">適合對象</h3>
                <p className="text-gray-700">
                  <strong>全體員工</strong>（特別推薦行政、業務、採購等常接觸郵件的人員）
                </p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-xl overflow-hidden border-t-4 border-danger-600">
            <div className="p-8">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  本課程教導 IT 人員如何建立完整的防護機制，包括備份策略、網路隔離、
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-danger-50 to-danger-100 p-6 rounded-lg">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start">
                        ...
                        <span><strong>時長：</strong>8 小時</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-danger-600 mr-2">•</span>
                      ...
                      <li className="flex items-start">
                        <span className="text-danger-600 mr-2">•</span>
                        <span><strong>形式：</strong>實體內訓 + 實機演練</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-danger-600 mr-2">•</span>
                        <span><strong>人數：</strong>5-15 人</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-danger-600 mr-2">•</span>
                        <span><strong>內容：</strong>防護策略 + 備份實作 + 應變演練 + 顧問諮詢</span>
                      </li>
                    </ul>
                  </div>
                  <div className="bg-gradient-to-br from-accent-50 to-accent-100 p-6 rounded-lg">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li className="flex items-start">
                        <span className="text-accent-600 mr-2">•</span>
                        <span><strong>服務：</strong>初次培訓 + 每季複訓 + 緊急支援</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-accent-600 mr-2">•</span>
                        <span><strong>適合：</strong>希望長期維護資安能力的企業</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-accent-600 mr-2">•</span>
                        <span><strong>內容：</strong>備份檢查 + 演練 + 24hr 技術支援熱線</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="flex items-start">
                    <span className="text-green-500 text-xl mr-2">✓</span>
                    <span className="text-gray-700">建立完整的 3-2-1 備份策略</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 text-xl mr-2">✓</span>
                    <span className="text-gray-700">遭受攻擊時可在 4 小時內恢復</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 text-xl mr-2">✓</span>
                    <span className="text-gray-700">降低 80% 資料永久遺失風險</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 text-xl mr-2">✓</span>
                    <span className="text-gray-700">節省超過百萬的潛在損失</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">適合對象</h3>
                <p className="text-gray-700">
                  <strong>IT 管理人員、系統管理員、資訊主管</strong>（負責企業伺服器與資料管理的人員）
                </p>
              </div>
            ...
            <div className="p-8">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  例如 ISO 27001 認證、個資法遵循、資安稽核等。對於傳統製造業而言，
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-secondary-50 to-secondary-100 p-6 rounded-lg">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start">
                        <span className="text-secondary-600 mr-2">•</span>
                        <span><strong>時長：</strong>8 小時（可分 2 次上課）</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-secondary-600 mr-2">•</span>
                      ...
                      <li className="flex items-start">
                        <span className="text-secondary-600 mr-2">•</span>
                        <span><strong>形式：</strong>實體內訓或線上直播</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-secondary-600 mr-2">•</span>
                        <span><strong>人數：</strong>10-20 人</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-secondary-600 mr-2">•</span>
                        <span><strong>內容：</strong>法規解讀 + 合約範例 + 稽核準備 + Q&A</span>
                      </li>
                    </ul>
                  </div>
                  <div className="bg-gradient-to-br from-primary-50 to-primary-100 p-6 rounded-lg">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li className="flex items-start">
                        <span className="text-primary-600 mr-2">•</span>
                        <span><strong>服務：</strong>現況診斷 + 客製培訓 + 文件協助</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 mr-2">•</span>
                        <span><strong>適合：</strong>準備 ISO 27001 認證或面臨客戶稽核的企業</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-primary-600 mr-2">•</span>
                        <span><strong>內容：</strong>缺口分析 + 改善建議 + 文件範本 + 模擬稽核</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="flex items-start">
                    <span className="text-green-500 text-xl mr-2">✓</span>
                    <span className="text-gray-700">理解 ISO 27001 與個資法基本要求</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 text-xl mr-2">✓</span>
                    <span className="text-gray-700">建立標準化的供應鏈資安條款</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 text-xl mr-2">✓</span>
                    <span className="text-gray-700">順利通過客戶資安稽核</span>
                  </div>
                  <div className="flex items-start">
                    <span className="text-green-500 text-xl mr-2">✓</span>
                    <span className="text-gray-700">提升企業形象與競爭力</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">適合對象</h3>
                <p className="text-gray-700">
                  <strong>採購、法務、品保、業務部門主管與人員</strong>（負責與客戶溝通合約與稽核的人員）
                </p>
              </div>
